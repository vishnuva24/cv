...
Elliptic Curves and Cryptography: Ireland rosen

I began my undergraduate degree at Ashoka with uncertainty about my major, but with a certainty about my desire for mathematical interactions. Through taking CS courses and interacting with topics in physics, I realised the true universality of maths, which makes me want to study the subject even more. I am also motivated by a curiosity to understand structure and see what objects structure naturally induces. This is the broader narrative of math for me, as a tool to model the world and understand its structure.

Through my courses, I have found myself learning best through pictures and visual intuition. I find my ongoing course on geometry and topology to be very engaging because of this. The proofs and definitions of the object, though very symbolic, carry behind them the visual intuition that adds a story to these subjects.

Through my current coursework and this mode of thinking, my interest has been directed towards learning Algebraic Topology, Geometry, and Geometric Group Theory. I am also currently reading introductory material in algebraic geometry, and I am planning to pursue my undergraduate thesis in this area. I am also interested in Complex Dynamics, for which I wrote an exposition last summer. I am eager to learn more about these topics, and VSRP would be a great opportunity for me to do this. 
